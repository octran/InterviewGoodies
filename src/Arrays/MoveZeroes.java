...
public class MoveZeroes {
	...
	public static void moveZeroesKeepOrder(int [] nums) {
		// O(n)
		if(nums == null || nums.length == 1) { return; } // not processing null or one element
		
		// start last non 0 element at 0, b/c we will process it anyways ex. {2,1,0}, first operation 2 = 2 anyways
	    int lastNonZero = 0;
	...
	public static void moveZeroesNoOrder(int[] nums) {
		...
		// (REDUNDANT) From Back of array, find the first non-zero j-th position (first swappable position)
