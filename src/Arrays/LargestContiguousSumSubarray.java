...
public class LargestContiguousSumSubarray {
	...
	public static void main(String[] args) {
		...
		// int [] inputArr = new int[] {-2, -3, -1}; // all negs will not work
		// with Kandanes
	...
	public static int largestContiguousSumKandanes(int[] nums) {
		// Kandanes algorithm
		// Find all the positive sums, does not handle all negative nums b/c
		// assuming 0
		// Keep track of max_so_far (maximum amount found) and max_ending_here
		// (array position)
	...
	public static int largestContiguousSumWorksForAllNegatives(int[] nums) {
		...
		// start at 1(next position tocheck)
